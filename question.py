VARKquestions = [("You have a bug in your code but don't know how to fix it - what do you do?",
...
def askQuestions(questions):
	...
	answers = []
#Asks questions in series and prompts answers. Answers are then saved in a list.
